                                        ...
                                        <div>
                                            <table class="detail-info-col">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="label6" runat="server" Text="Approved date : "></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblApprove" runat="server"></asp:Label></td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <asp:Label ID="label5" runat="server" Text="Fulfilled date : "></asp:Label></td>
                                                        <td>
                                                            <asp:Label ID="lblFulfill" runat="server"></asp:Label></td>
                                                    </tr>
                                                </tbody>
                                            </table>
