                            ...
                            <asp:ListView runat="server" ID="lstOrder">
                                        ...
                                        <thead>
                                            <tr id="Tr1" runat="server">
                                                ...
                                                <th scope="col" class="desktop">Submitted Date</th>
                                                 <th scope="col" class="desktop">Approved Date</th>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="desktop">
                                            <asp:Label runat="server" ID="Label8" Text='<%# Eval("SubmittedDate") %>' />
                                        </td>
                                        <td>
                                    ...
                                    <table class="detail-info-col">
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <tr>
                                                <td>
                                                    <asp:Label ID="label9" runat="server" Text="Approved Date : "></asp:Label></td>
                                                <td>
                                                    <asp:Label ID="Label10" runat="server" Text="12/06/1992"></asp:Label></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label7" runat="server" Text="Fulfilled Date : "></asp:Label></td>
                                                <td>
